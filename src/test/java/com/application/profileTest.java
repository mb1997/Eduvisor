...
//	 */
	 ...
	 * mockMvc.perform(get("/addQuestion")) .andExpect(redirectedUrl(""))
	 * //.andExpect(model().attribute("loggedinUser", new
	 ...
	 * user=userService.getUserByMail("vmandowara11@gmail.com");
	 * mockMvc.perform(get("/addQuestion") .sessionAttr("user",user))
	 * .andExpect(view().name("/ask_question"))
	 * .andDo(MockMvcResultHandlers.print()) .andReturn(); }
	 * 
	 * @Test public void getUpdatequestion() throws Exception {
	 * mockMvc.perform(get("/updatepost?s=5d299505abe88c1258bd7eed"))
	 * .andExpect(redirectedUrl("login")) .andDo(MockMvcResultHandlers.print())
	 * .andReturn(); }
	 * 
	 * @Test public void sessiongetUpdatequestion() throws Exception { User
	 * user=userService.getUserByMail("vmandowara11@gmail.com");
	 * mockMvc.perform(get("/updatepost?s=5d299505abe88c1258bd7eed")
	 * .sessionAttr("user",user)) .andExpect(view().name("update_post"))
	 * .andDo(MockMvcResultHandlers.print()) .andReturn(); }
	 * 
	 * 
	 * 
	 ...
	 * .andReturn(); }
	 * 
	 * @Test public void sessiondownvote() throws Exception { User
	 * user=userService.getUserByMail("vmandowara11@gmail.com");
	 * mockMvc.perform(get(
	 * "/downVote?id=cfe56261-8a56-4f5f-a08b-6adf3235e837&post=5d1f286cff7df8368c30fb40")
	 * .sessionAttr("user",user)) // .andExpect(view().name(""))
	 * .andDo(MockMvcResultHandlers.print()) .andReturn(); }
	 */
